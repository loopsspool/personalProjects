...
@pytest.mark.parametrize("poke_form_id, game_id, expected", [
    ...
    ((493, get_form_id(cursor, "-Form-Fairy")), get_game_id(cursor, "BW_B2W2"), False),
    ((493, get_form_id(cursor, "-Form-Fairy")), get_game_id(cursor, "XY_ORAS"), True),
    ...
    ((19, get_form_id(cursor, "-Region-Alola")), get_game_id(cursor, "XY_ORAS"), False),
    ((19, get_form_id(cursor, "-Region-Alola")), get_game_id(cursor, "SM_USUM"), True),
    ...
    ((52, get_form_id(cursor, "-Region-Galar")), get_game_id(cursor, "BW_B2W2"), False),
    ...
    # Specific Pokemon
    ((25, get_form_id(cursor, "-Form-Cosplay-Belle")), get_game_id(cursor, "BW_B2W2"), False),
    ((25, get_form_id(cursor, "-Form-Cosplay-Libre")), get_game_id(cursor, "SM_USUM"), False),
    ((25, get_form_id(cursor, "-Form-Cosplay-PhD")), get_game_id(cursor, "XY_ORAS"), True),
    ((25, get_form_id(cursor, "-Form-Cap-Hoenn")), get_game_id(cursor, "XY_ORAS"), False),
    ((25, get_form_id(cursor, "-Form-Cap-Alola")), get_game_id(cursor, "LA"), False),
    ((25, get_form_id(cursor, "-Form-Cap-Alola")), get_game_id(cursor, "SM_USUM"), True),
    ((25, get_form_id(cursor, "-Form-Cap-Unova")), get_game_id(cursor, "SV"), True),
    ((25, get_form_id(cursor, "-Form-Cap-World")), get_game_id(cursor, "SM_USUM"), False),
    ...
    ((172, get_form_id(cursor, "-Form-Spiky_Eared")), get_game_id(cursor, "Diamond_Pearl"), True),
    ...
    ((201, get_form_id(cursor, "-Form-!")), get_game_id(cursor, "Ruby_Sapphire"), True),
    ((201, get_form_id(cursor, "-Form-Qmark")), get_game_id(cursor, "FRLG"), True),
    ((382, get_form_id(cursor, "-Form-Primal")), get_game_id(cursor, "BW_B2W2"), False),
    ((383, get_form_id(cursor, "-Form-Primal")), get_game_id(cursor, "SwSh"), False),
    ((382, get_form_id(cursor, "-Form-Primal")), get_game_id(cursor, "XY_ORAS"), True),
    ((383, get_form_id(cursor, "-Form-Primal")), get_game_id(cursor, "SM_USUM"), True),
    ((479, get_form_id(cursor, "-Form-Heat")), get_game_id(cursor, "Diamond_Pearl"), False),
    ...
    ((487, get_form_id(cursor, "-Form-Origin")), get_game_id(cursor, "Diamond_Pearl"), False),
    ((487, get_form_id(cursor, "-Form-Origin")), get_game_id(cursor, "Platinum"), True),
    ((487, get_form_id(cursor, "-Form-Origin")), get_game_id(cursor, "BW_B2W2"), True),
    ((492, get_form_id(cursor, "-Form-Sky")), get_game_id(cursor, "Diamond_Pearl"), False),
    ((492, get_form_id(cursor, "-Form-Sky")), get_game_id(cursor, "Platinum"), True),
    ((492, get_form_id(cursor, "-Form-Sky")), get_game_id(cursor, "BW_B2W2"), True),
    ((493, get_form_id(cursor, "-Form-Qmark")), get_game_id(cursor, "BW_B2W2"), False),
    ((493, get_form_id(cursor, "-Form-Qmark")), get_game_id(cursor, "Diamond_Pearl"), True),
    ((658, get_form_id(cursor, "-Form-Ash")), get_game_id(cursor, "XY_ORAS"), False),
    ((658, get_form_id(cursor, "-Form-Ash")), get_game_id(cursor, "SV"), False),
    ((658, get_form_id(cursor, "-Form-Ash")), get_game_id(cursor, "SM_USUM"), True),
    ((718, get_form_id(cursor, "-Form-10%")), get_game_id(cursor, "XY_ORAS"), False),
    ((718, get_form_id(cursor, "-Form-50%")), get_game_id(cursor, "XY_ORAS"), True),
    ((718, get_form_id(cursor, "-Form-Complete")), get_game_id(cursor, "SM_USUM"), True),
    ...
    ((791, get_form_id(cursor, "-Form-Radiant_Sun")), get_game_id(cursor, "SM_USUM"), True),
    ((792, get_form_id(cursor, "-Form-Full_Moon")), get_game_id(cursor, "SM_USUM"), True),
    ((802, get_form_id(cursor, "-Form-Zenith")), get_game_id(cursor, "SwSh"), False),
    ((802, get_form_id(cursor, "-Form-Zenith")), get_game_id(cursor, "SM_USUM"), True),
...
@pytest.mark.parametrize("pfgo_id, sprite_type, expected", [
    ...
    ((493, get_form_id(cursor, "-Form-Steel"), get_game_id(cursor, "Diamond_Pearl")), "-Back-Animated", False),
    ((493, get_form_id(cursor, "-Form-Steel"), get_game_id(cursor, "BW_B2W2")), "-Back-Animated", True),
